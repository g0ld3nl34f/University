...
<string>[^\"\n]* {strappend(&yylval.str, yytext); printf("STRING LIT (part): %s\n", yytext); INC_COL(strlen(yytext));}
<string>\n {strappend(&yylval.str, "\n"); INC_LINE;}
<string>\" {INC_COL(1); printf("END STRING LIT: '%s'\n", yylval.str); BEGIN(INITIAL); return STRLIT; }
...
\n { INC_LINE; }
{WHITESPACE} { INC_COL(strlen(yytext)); }
. {/*erro!*/}

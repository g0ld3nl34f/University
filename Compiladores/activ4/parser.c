...
double get_var(char id){ return vars[((int) id) - ASCII_OF_A]; }

void set_var(char id, double val){ vars[((int) id) - ASCII_OF_A] = val;}
...
{
  "$end", "error", "$undefined", "INTLIT", "FLOATLIT", "ID", "NL",
  "ASSIGN", "SUB", "ADD", "MUL", "DIV", "NEG", "LPAR", "RPAR", "$accept",
...
{
      11,    -6,    -6,    16,    -6,    17,    17,     2,    11,    -3,
      17,    -6,    18,    -6,    -6,    -6,    17,    17,    17,    24,
      -6,    -1,    -6,    -6
};
...
{
       2,     6,     7,    13,     4,     0,     0,     0,     2,     0,
       0,    11,     0,     1,     3,     5,     0,     0,     0,    14,
      12,     8,     9,    10
};
...
{
      11,    12,    13,    15,    14,    19,    16,    17,    18,    17,
      18,    21,    22,    23,     1,     2,     3,     4,     0,     5,
       1,     2,     3,    10,     6,     5,     0,    16,    17,    18,
       6,     0,    20,    16,    17,    18
};

static const yytype_int8 yycheck[] =
{
       5,     6,     0,     6,     8,    10,     9,    10,    11,    10,
      11,    16,    17,    18,     3,     4,     5,     6,    -1,     8,
       3,     4,     5,     7,    13,     8,    -1,     9,    10,    11,
      13,    -1,    14,     9,    10,    11
};
...
{
       0,     3,     4,     5,     6,     8,    13,    16,    17,    18,
       7,    18,    18,     0,    16,     6,     9,    10,    11,    18,
      14,    18,    18,    18
};
...
#line 41 "calc.y" /* yacc.c:1646  */
    { (yyval.val) = 0; }
#line 1254 "parser.c" /* yacc.c:1646  */
    break;

  case 5:
#line 42 "calc.y" /* yacc.c:1646  */
    { (yyval.val) = (yyvsp[-1].val); printf ("%.2lf\n", (yyval.val)); }
...
#line 52 "calc.y" /* yacc.c:1646  */
    { (yyval.val) = get_var((yyvsp[0].id)[0]); }
#line 1308 "parser.c" /* yacc.c:1646  */
    break;

  case 14:
#line 53 "calc.y" /* yacc.c:1646  */
    { (yyval.val) = (yyvsp[0].val); set_var((yyvsp[-2].id)[0], (yyvsp[0].val)); }

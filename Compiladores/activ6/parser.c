...
{
  "$end", "error", "$undefined", "NUM", "ID", "NL", "ASSIGN", "SUB",
  "ADD", "MUL", "DIV", "NEG", "LPAR", "RPAR", "$accept", "input", "seq",
  "exp", YY_NULLPTR
};
#endif
...
{
      11,    -8,    10,    11,    11,    17,    -8,    -1,    11,    -8,
      12,    -8,    11,    11,    11,    11,    11,    19,    -8,    -8,
      -7,    -7,    -8,    -8
};
...
{
       3,     5,     6,     0,     0,     0,     2,     0,     0,    11,
       0,     1,     3,     0,     0,     0,     0,    13,    12,     4,
       8,     7,     9,    10
};
...
{
       9,    10,    15,    16,    12,    17,    13,    14,    15,    16,
      20,    21,    22,    23,     1,     2,     8,    11,     3,    13,
      14,    15,    16,     4,     0,    18,    13,    14,    15,    16,
      19
};

static const yytype_int8 yycheck[] =
{
       3,     4,     9,    10,     5,     8,     7,     8,     9,    10,
      13,    14,    15,    16,     3,     4,     6,     0,     7,     7,
       8,     9,    10,    12,    -1,    13,     7,     8,     9,    10,
      12
};
...
{
       0,     3,     4,     7,    12,    15,    16,    17,     6,    17,
      17,     0,     5,     7,     8,     9,    10,    17,    13,    16,
      17,    17,    17,    17
};
...
#line 36 "calc.y" /* yacc.c:1646  */
    { (yyval.seq) = calc_seq_new_empty(); }
#line 1256 "parser.c" /* yacc.c:1646  */
    break;

  case 4:
#line 37 "calc.y" /* yacc.c:1646  */
    { (yyval.seq) = calc_seq_new_exp((yyvsp[-2].exp), (yyvsp[0].seq)); }
